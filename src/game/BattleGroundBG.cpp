...
void BattleGroundBG::Reset()
{
    ...
    m_HonorTics = (isBGWeekend) ? BG_BG_ABBGWeekendHonorTicks : BG_BG_NotABBGWeekendHonorTicks;
    m_ReputationTics = (isBGWeekend) ? BG_BG_ABBGWeekendReputationTicks : BG_BG_NotABBGWeekendReputationTicks;
...
bool BattleGroundBG::IsAllNodesConrolledByTeam(Team team) const
{
    uint32 count = 0;
    for (int i = 0; i < BG_BG_NODES_MAX; ++i)
