...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_MAX_PLAYER_LEVEL_PANDAREN,
    CONFIG_UINT32_MAX_PLAYER_LEVEL,
    CONFIG_UINT32_START_PLAYER_LEVEL_PANDAREN,
	...
	CONFIG_UINT32_SKILL_CHANCE_ARCHAEOLOGY_STEPS,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_ARCHAEOLOGY_AMOUNT,
    CONFIG_FLOAT_RATE_ARCHAEOLOGY_NEXT,
