...
void LoadDBCStores(const std::string& dataPath)
{
    ...
    if (!sAreaStore.LookupEntry(5139)              ||       // last area (areaflag) added in 5.0.1 Beta
        !sCharTitlesStore.LookupEntry(314)         ||       // last char title added in 5.0.1 Beta
        !sGemPropertiesStore.LookupEntry(3142)     ||       // last gem property added in 5.0.1 Beta
        !sMapStore.LookupEntry(1060)               ||       // last map added in 5.0.1 Beta
        !sSpellStore.LookupEntry(127517)           )        // last added spell in 5.0.1 Beta
    {
