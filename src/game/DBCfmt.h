...
const char SpellClassOptionsEntryfmt[]="nxiiixix";
const char SpellCooldownsEntryfmt[]="nixiii";
const char SpellEffectEntryfmt[]="nixifiiixfiiiiiifixfiiixiiiiix";
...
const char SpellMiscEntryfmt[]="nixiiiiiiiiiixiiifiiiii";
const char SpellPowerEntryfmt[]="nixiiiixxxxxx";
const char SpellReagentsEntryfmt[]="niiiiiiiiiiiiiiiixx";
...
const char SpellRadiusfmt[]="nixxx";
