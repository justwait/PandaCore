...
enum Opcodes335a
{
    ...
    SMSG_SPELL_GO,
    //EVENT_SHOW_FACTION_SELECT_UI                    = 0x343, // Soon
    //EVENT_NEUTRAL_FACTION_SELECT_RESULT            = 0x344, // Soon
    //PET_JOURNAL_LIST_UPDATE                        = 0x349,
    //EVENT_BATTLE_PET_CURSOR_CLEAR                 = 0x34A,
    //EVENT_PVP_POWER_UPDATE                         = 0x34C,
    //EVENT_BATTLE_PET_OPENING_START                 = 0x34D,
    //EVENT_BATTLE_PET_OPENING_DONE                 = 0x34E,
    //EVENT_BATTLE_PET_HEALTH_CHANGED                 = 0x34F,
    //EVENT_BATTLE_PET_TURN_STARTED                 = 0x350,
    //EVENT_BATTLE_PET_PET_CHANGED                     = 0x351,
    //EVENT_BATTLE_PET_FINAL_ROUND                     = 0x352,
    //EVENT_BATTLE_PET_CLOSE                         = 0x353,
    //EVENT_BATTLE_PET_PET_ROUND_RESULTS             = 0x354,
    //EVENT_BATTLE_PET_PET_ROUND_PLAYBACK_COMPLETE  = 0x355,
    //EVENT_BATTLE_PET_ACTION_SELECTED                = 0x356,
    //EVENT_CHALLENGE_MODE_MAPS_UPDATE                = 0x357,
	//EVENT_BATTLE_PET_PVP_DUEL_REQUESTED
	//EVENT_BATTLE_PET_PVP_DUEL
	//EVENT_BATTLE_PET_MAX_HEALTH_CHANGED
	//EVENT_BATTLE_PET_AURA_APPLIED
	//EVENT_BATTLE_PET_AURA_CANCELED
	//EVENT_BATTLE_PET_AURA_CHANGED
	//EVENT_BATTLE_PET_EVENT_ON_APPLY
	//EVENT_BATTLE_PET_EVENT_ON_DAMAGE_TAKEN
	//EVENT_BATTLE_PET_EVENT_ON_DAMAGE_DEALT
	//EVENT_BATTLE_PET_EVENT_ON_HEAL_TAKEN
	//EVENT_BATTLE_PET_EVENT_ON_HEAL_DEALT
};
